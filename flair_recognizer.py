"""
Code copy directly from Presidio Analyzer's Flair Recognizer.
reference: https://github.com/microsoft/presidio/blob/main/docs/samples/python/flair_recognizer.py 
"""
